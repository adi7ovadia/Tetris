...
public class Tetris extends JFrame 
{
	...
	/**
	 * The id the of the game
	 */
	private int gameID;
	
	private Socket socket;
	/**
	 *The output that send to the server
	 *<br>From the type: {@link DataOutputStream}. 
	 */
	private DataOutputStream toServer=null;
	/**
	 *The input that comes from the server
	 *<br>From the type: {@link DataInputStream}. 
	 */
	...
	/**
	 *The name of the player at this client
	 */
    
    public Tetris() throws UnknownHostException, IOException 
    {
		...
		{ 
			...
			setMyClientNumber(fromServer.readInt());
	...
	/**
	 * The clientExit manage the exit of the game
	 */
...
public int getMyClientNumber() {
	return myClientNumber;
}


public void setMyClientNumber(int myClientNumber) {
